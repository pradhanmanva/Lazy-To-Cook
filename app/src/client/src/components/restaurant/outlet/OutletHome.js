            ...
            <div className="outlet-list-tray">   
                <BrowserRouter  forceRefresh={true} basename="/app">    
                    <h4 className="outlet-title">
                        ...
                        <button className="operation-btn" title="Add New Outlet"><i className="fas fa-plus"></i></button>
                        </Link>
                    </h4>
                                ...
                                <li className="outlet-list-item" key={outlet.id} >
                                    ...
                                    <span className="float-right">
                                        <Link className="float-right" to={`${self.props.match.url}/${outlet.id}/edit`} >
                                            <button className="operation-btn" title="Edit"><i className="fas fa-pen"></i></button>
                                        </Link>
                                        <Link className="float-right" to={`${self.props.match.url}/${outlet.id}/delete`} >
